...
/**
 *
 * @brief los discos a utilizar por el RAID
 */
class diskNode{
public:
    bool isLleno=false;
...
/**
 *
 * @brief Metadata encargada de la busqueda
 */
class metaData{
public:
    vector<string> path;
...
/**
 *
 * @brief divide el video en partes iguales y verifica que sea posible guardarlo
 * @param direccion el path del archivo
 */
...
/**
 *
 * @brief acomoda los parametros iniciales para iniciar el RAID
 */
void iniciarRaid(){
...
/**
 *
 * @brief revisa el siguiente espacio libre de memoria para guardar en el RAID
 * @param array recibe una parte del array del video
 */
void revisarInsertarRAID(int array[]){
    int contador = 0;
    int contador2 = 0;
...
/**
 *
 * @brief revisa que la paridad sea distribuida (no se inserta en el mismo disco que una de sus partes)
 * @param array paridad del video
 */
...
/**
 *
 * @brief crea un nodo y lo guarda en el disco
 */
void agregarNodo(){
    diskNode disco;
...
/**
 *
 * @brief obtiene los bits de un arraglo de bytes
 * @param array arreglo de bytes
 * @param size tamano del arreglo de bytes
 */
void getBits(int* array, int size){
    int x;
    int y =0;
...
/**
 *
 * @brief obtiene los bits de un arreglo de bytes y se los devuelve al programador
 * @param array arreglo de bytes
 * @param size tamano del arreglo de bytes
 * @return un vector con los bits
 */
...
/**
 *
 * @brief busca los archivos en una carpeta
 * @param dir path de la carpeta
 */
...
/**
 *
 * @brief crear el video apartir de su byte array
 * @param array arreglo de bytes del video
 * @param size tamano del arreglo de bytes
 */
void generateVid(int* array, int size){
...
/**
 *
 * @brief Permite verificar que el video se divide en partes iguales, retorna el video incompleto
 * @param array
 * @param size
 */
...
/**
 *
 * @brief Permite eliminar un disco con memoria almacenada en el
 * @param disc
 */
...
/**
 *
 * @brief Aplica la funcion de Xor para hacer la recuperacion de datos
 * @param a
 * @param b
 * @param tamanoA
 * @param tamanoB
